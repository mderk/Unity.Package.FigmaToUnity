...
{
    public enum EffectType { INNER_SHADOW, DROP_SHADOW, LAYER_BLUR, BACKGROUND_BLUR, NOISE, TEXTURE }
    ...
    public enum PaintType { SOLID, GRADIENT_LINEAR, GRADIENT_RADIAL, GRADIENT_ANGULAR, GRADIENT_DIAMOND, IMAGE, EMOJI, PATTERN }
    ...
    public enum Navigation { NAVIGATE, SWAP, OVERLAY, SCROLL_TO, CHANGE_TO }

    public enum TransitionType { DISSOLVE, SMART_ANIMATE, SCROLL_ANIMATE, MOVE_IN, MOVE_OUT, PUSH, SLIDE_IN, SLIDE_OUT }
    ...
    public enum EasingType { EASE_IN, EASE_OUT, EASE_IN_AND_OUT, LINEAR, EASE_IN_BACK, EASE_OUT_BACK, EASE_IN_AND_OUT_BACK, CUSTOM_CUBIC_BEZIER, GENTLE, QUICK, BOUNCY, SLOW, CUSTOM_SPRING }

    public enum LayoutAlign { CENTER, MIN, MAX, STRETCH, INHERIT }

    public enum StrokeCap { NONE, ROUND, SQUARE, ARROW_LINES, ARROW_EQUILATERAL, LINE_ARROW, TRIANGLE_ARROW, DIAMOND_FILLED, CIRCLE_FILLED, TRIANGLE_FILLED, WASHI_TAPE_1, WASHI_TAPE_2, WASHI_TAPE_3, WASHI_TAPE_4, WASHI_TAPE_5, WASHI_TAPE_6 }
    ...
    public enum TextCase { ORIGINAL, UPPER, LOWER, TITLE, SMALL_CAPS, SMALL_CAPS_FORCED }
    ...
    public enum NodeType { DOCUMENT, CANVAS, SLICE, FRAME, GROUP, COMPONENT_SET, COMPONENT, INSTANCE, BOOLEAN_OPERATION, VECTOR, STAR, LINE, ELLIPSE, REGULAR_POLYGON, RECTANGLE, TEXT, SECTION, SHAPE_WITH_TEXT, CONNECTOR, STICKY, TABLE, TABLE_CELL, WASHI_TAPE, WIDGET, EMBED, LINK_UNFURL, TEXT_PATH, TRANSFORM_GROUP }
